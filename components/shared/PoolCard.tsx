...
export function PoolCard({ pool }: { pool: PoolCardModel }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -2 }}
    >
      <Card className="group relative gap-0 overflow-hidden p-0 transition-all duration-300 hover:border-accent/30 hover:shadow-[0_0_0_1px_rgba(31,107,71,0.10),0_20px_40px_-22px_rgba(31,107,71,0.25)]">
        ...
        <div className="mt-4 grid grid-cols-3 gap-3 border-t border-line/60 px-6 py-4 text-xs">
          ...
          <div>
            ...
            <p className="mono-num mt-0.5 text-accent">{fmtPct(apy, 1)}</p>
          </div>
          <div>
