...
export const CUBE_MEANINGS: Record<Meaning, { label: string; faces: Face[] }> = {
  protocol: {
    ...
    faces: [
      ...
      { code: "02", title: "Underwriting", desc: "Calibrated, physics-verified savings model. 90% conformal PI. Audit baselines on-chain.", rows: [["Risk model", "PINN"], ["Auditors", "BEE · TÜV"], ["Avg. tier", "BBB+"]] },
