...
const PatchSchema = z
  .object({
    ...
    aboutPool: z.string().max(5_000).nullable().optional(),
    ...
    expectedApyBps: z.number().int().min(0).max(10_000).nullable().optional(),
  })
  .strict();
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/admin/pools/[id]", err);
    return NextResponse.json(
      {
        error: "db-error",
